...
export class ChallengeService {
  ...
  index(
    ...
    if (filters) {
      ...
      if (filters.metodo_pontuacao)
        params = params.set('metodo_pontuacao', filters.metodo_pontuacao);
  ...
  store(data: {
    ...
    if (data.meta_pontuacao != null)
      formData.append('meta_pontuacao', data.meta_pontuacao.toString());
  ...
  update(
    ...
    if (data.pontos_recompensa !== undefined)
      formData.append('pontos_recompensa', data.pontos_recompensa.toString());
    if (data.duracao_dias !== undefined)
      formData.append('duracao_dias', data.duracao_dias.toString());
    if (data.metodo_pontuacao)
      formData.append('metodo_pontuacao', data.metodo_pontuacao);
    if (data.meta_pontuacao !== undefined)
      formData.append('meta_pontuacao', data.meta_pontuacao.toString());
    if (data.url_foto) formData.append('url_foto', data.url_foto);
